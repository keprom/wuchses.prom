...
ORDER BY
  tariff_value.id ASC";
	...
	function svod()
	{
		...
		$sql="select $params,firm_subgroup.name as subgroup,firm.dogovor from industry.firm left join industry.firm_subgroup on firm.subgroup_id=firm_subgroup.id ".$sql." order by firm.dogovor";
