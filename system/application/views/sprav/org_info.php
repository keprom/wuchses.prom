...
БИН организации <input name=bin value='<?php echo $org_info->bin;?>'>
<br>
Свидетельство по НДС <input name=svidetelstvo_nds value='<?php echo $org_info->svidetelstvo_nds;?>'><br>
