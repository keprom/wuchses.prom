...
<body>
 <table width=100% >
 <tr>
 <td align=left> <center><b>СЧЕТ на<?php echo $schet;?> №</b>
<?php echo $number.' от ';
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td align=left> Aдрес поставщика:&nbsp; <?php echo $org->address;?></u> </td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td align=left> Договор(контракт) на поставку товаров (работ, услуг) № <?php if ($firm->dog_hernya=='') {echo $firm->dogovor."   </u> от <u>    ".datetostring($firm->dogovor_date);} else {echo $firm->dog_hernya;}?></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td align=left> Aдрес покупателя: &nbsp; <u><?php echo $firm->address; ?></u></td>
 <td> (8б)</td>
 </tr>
 <tr>
