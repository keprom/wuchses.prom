...
$sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*$tar[1];
...
$_sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*$tar[1];
...
<td>
	<?php echo f_d(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*$tar[1]);?>
</td> 

<td>
	<?php echo f_d(($d->tenge_day+$d->tenge_night+$d->tenge_evening)-(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*$tar[1]));?>
</td> 
 ...
 <td align=right>
  <b><?php echo f_d(($sum_day_tenge+$sum_night_tenge+$sum_evening_tenge)-$sum_otp_nds);?></b>
 </td>
 ...
 <td align=right>
  <b><?php echo f_d(($_sum_night_tenge+$_sum_day_tenge+$_sum_evening_tenge)-$_sum_otp_nds);?></b>
 </td>
