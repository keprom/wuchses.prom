...
<body>
 ...
 <tr align=center>
 <td width=2100px> 
 <b><?php echo (strlen(trim($akt_vypolnenyh_rabot))==0?"СЧЕТ-ФАКТУРА":$akt_vypolnenyh_rabot);?> №</b> <?php 
 echo ($schetfactura_date->id >= 99999 ?'0':'').$schetfactura_date->id.' от ';
...
<b>Поставщик</b> <u><?php echo $org->org_name; ?></u>
 ...
 <tr >
 <td width=2100px> 
Адрес поставщика <?php echo ": <u>".$org->address;?></u>
 </td>
 <td> (3)</td>
 </tr>
 <tr>
...
<tr>
 ...
 БИК  <?php echo $org->bank_bik;?>            БИН/ИИН  <?php echo $org->bin; ?> </td>
 <td> </td>
 </tr>
 <tr>
 ...
 <td> (8)</td>
  ...
  <tr>
 <td width=2100px> Покупатель <u><?php echo "{$firm->name}  БИН/ИИН {$firm->bin}"; ?></u></td>
 <td> (8а)</td>
 </tr>
 <tr>
 <td width=2100px> Адрес покупателя <u><?php echo $firm->address; ?></u></td>
 <td> (8б)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px> БИН/ИИН <?php echo $firm->bin;?></td>
 <td> (8г)</td>
 </tr>
 </table>
 <br>
